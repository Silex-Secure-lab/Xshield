            ...
            <div className='flex justify-between mt-10 text-[13.2px] mobile-flex-col'>
                <div className='flex max-w-[47%] gap-5 mobile-width-full'>
                    ...
                    <p> <b>Revolutionizing Survillance and Rapid Response </b>
                        ...
                        <br /> <br />In the ongoing war against banditry and terrorism, where swift responses can mean the difference between life and death, we have seen collateral damages often recorded whenever security agencies are not able to predict the enemy’s next move or when they completely lose sight of the enemy’s position per time or delay in responding to distress calls in the event of an attack.

                        <br /><br />In addressing this challenge, the deployment of cutting-edge solutions that will enhance troop’s surveillance and response capabilities cannot be over-emphasized. Imagine a single solution that enhances vigilance, coordination, and immediate responses to emergencies all at once. X-shield presents the Autonomous Surveillance Outpost and Tower – a strategic approach to security that redefines surveillance, heightens coordination, and revolutionizes response mechanisms.

                        <br /><br />“Purpose-built to serve as Surveillance and  Quick Response Stations, they revolutionize  the oversight of remote border communities and attack-prone, high-risk areas. By preemptively countering potential attacks by non-state entities, the ASO acts as the  frontline outpost of Quick Response Force.”

...
function ServicePremier() {
    return (
        <div className="bg-[#EEECE9] text-[#4A4A4B] w-[100%] px-[8%] !mt-5 py-12">
            <h4 className='text-[#7C5E50] text-[13px] font-medium'>Why Choose Us</h4>
            ...
            <div className="bg-[#EEECE9] text-[#4A4A4B] flex justify-between mt-10 w-[100%] mobile-flex-col">
                <div className='max-w-[46%] mobile-width-full flex flex-col gap-5'>
                    <div className='flex gap-4 max-w-[80%] mobile-width-full '>

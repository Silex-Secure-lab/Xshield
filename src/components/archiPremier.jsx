...
function ArchiPremier() {
    return (
        <div className="bg-[#000000] text-[#E5E5E5] w-[100%] px-[8%] !mt-20 py-20">
            <h4 className='text-[35px] font-bold uppercase text-center'>Architectural Armouring</h4>
            <h4 className='text-[15px] !mt-5 text-center'>Architectural armouring involves reinforcing buildings and structures to withstand various forms of <br /> attacks or natural disasters. These can include.</h4>
            <div className="bg-[#000000] text-[#E5E5E5] flex justify-between mt-20 w-[100%] mobile-flex-col">

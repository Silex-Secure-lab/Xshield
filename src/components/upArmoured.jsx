...
function UpAmoured() {
    return (
        <div className="bg-[#000000] text-[#E5E5E5] w-[100%] px-[8%] py-20">
            <h5 className="font-bold text-[35px] text-center">Up-Armoured Reinforced Patrol Trucks</h5>
            <p className='text-center'>An Impenetrable shield offering protection  to troops against Ambush Scenarios</p>

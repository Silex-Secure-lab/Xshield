...
function ShieldCore() {
    return (
        <div className="bg-[#000000] text-[#E5E5E5] w-[100%] px-[8%] py-5 mb-10 mt-15">
            ...
            <div className="w-[130px] h-[1px] bg-white m-auto mt-1 !mb-20" />

            <div className="flex justify-between items-center text-[14px] text-[#E5E5E5]">

                <div className='flex flex-col items-center rounded-[10px] px-8 gap-2 py-5'>
            ...
            <div className='flex flex-col items-center rounded-[10px] px-8 gap-2 py-5 w-fit m-auto'>

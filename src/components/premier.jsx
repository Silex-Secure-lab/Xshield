            ...
            <div className='bg-white max-w-[47%] ml-[-50px] pl-[60px] '>
                <div className='py-[30px] flex gap-10'>
                    ...
                    <div className='text-black'>
                        ...
                        <img src={lexus} alt='lexus' className='mt-[-40px]' />
                    </div>
                ...
                <div className='py-[60px] flex items-center'>
                    <img src={wall} alt='lexus' className='w-[60%] h-full ml-[-50px]' />
                    <div className=' flex flex-col justify-end items-center gap-5 w-[45%]'>
                ...
                <div className='py-[20px] flex items-end pb-[40px]'>
                    <div className=' flex flex-col justify-end items-center gap-5 w-[36%]'>
                        ...
                        <div className='text-black text-[13.5px] min-w-[100%] ml-[-10px]'>
                            <ul className="list-disc">
                                <li>
                    ...
                    <img src={shield} alt='lexus' className='w-[45%] h-full ml-[-20px]' />
                    <img src={surveil} alt='lexus' className='w-[45%] h-full ml-[-110px] mb-[-30px]' />
